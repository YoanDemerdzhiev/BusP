...
export default function ProblemLineSelectPage() {
        ...
        <div className="p-4">
          ...
          <div className="space-y-2 max-h-[60vh] overflow-y-auto">
            {filteredLines.map((line) => (
              <button
                key={line.line}
                onClick={() => router.push(`/problem/report?line=${line.line}`)}
                className="w-full flex items-center gap-3 p-4 bg-white dark:bg-slate-700 rounded-xl border border-slate-100 dark:border-slate-600 hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-slate-600 transition-all"
              >
