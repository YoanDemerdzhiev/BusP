    ...
    <ProtectedRoute>
      <PhoneFrame>
          ...
          <div className="space-y-3 max-h-[60vh] overflow-y-auto">
            ...
            {filteredItems.map((item) => (
              <button
                ...
                className="w-full text-left p-4 bg-white dark:bg-slate-700 rounded-xl border border-slate-100 dark:border-slate-600 hover:border-amber-500 transition-all"
              >
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-white dark:from-slate-800 to-transparent pt-8">
          <button
            onClick={() => router.push('/lost/create')}
            className="w-full py-4 bg-amber-500 text-white font-semibold rounded-xl shadow-lg hover:bg-amber-600 transition-colors flex items-center justify-center gap-2"
          >
